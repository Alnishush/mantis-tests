...
namespace mantis_tests
{
    public class FtpHelper : HelperBase
    {
        ...
        public void BackupFile(String path) // Временно прячет конфигурационный файл на сервере для восстановления позже
        {
        ...
        public void RestoreBackupFile(String path) // Восстанавливает конфигурационный файл из резервной копии
        {
            String backupPath = path + ".bak";
            if (! client.FileExists(backupPath))
            { 
